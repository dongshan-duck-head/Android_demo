...
public class ImageClassifierImageNet extends ImageClassifier {
    /**
    ...
    /**
     * An array to hold inference results, to be feed into Tensorflow Lite  outputs.
     * This isn't part of the super class, because we need a primitive array ashere.
     */
     ...
     * @param activity
     */
    ImageClassifierImageNet(Activity activity) throws IOException {
        super(activity);
